							...
							<div class="col-lg-8">
								<div class="central-meta">
									<div class="editing-info">
										...
										<form method="post" action="edit-basic.php">
											<div class="form-group">	
											  <input type="text" required="required" name="Full_Name" />
											  <label class="control-label">Full Name</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group">	
											...
											<div class="form-group">	
											  ...
											  <label class="control-label">Phone No.</label><i class="mtrl-select"></i>
											</div>
											<div class="form-group half">
												<h5>Date of Birth</h5>
												<input type="date" style="padding-right: 230px" name="DOB">
											</div>
											<div class="form-radio">
											  <div class="radio">
												<label>
												  <input type="radio" checked="checked" name="gender" value="Male"><i class="check-box"></i>Male
												</label>
											  </div>
											  <div class="radio">
												<label>
											...
											<div class="form-group">	
											  <textarea rows="2" id="textarea" required="required" name="aboutMe"></textarea>
